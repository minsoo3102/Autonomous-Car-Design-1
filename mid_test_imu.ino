...
#define TRIG1 39 // 초음파 센서 1번 Trig 핀 번호
#define ECHO1 38 // 초음파 센서 1번 Echo 핀 번호

#define TRIG2 37 // 초음파 센서 2번 Trig 핀 번호
#define ECHO2 36 // 초음파 센서 2번 Echo 핀 번호

#define TRIG3 35 // 초음파 센서 3번 Trig 핀 번호
#define ECHO3 34 // 초음파 센서 3번 Echo 핀 번호
